...
private let logger = Logger(subsystem: "com.arbiter", category: "RequestSanitiser")
...
private extension RequestSanitiserMiddleware {
    func validateNotEmpty(_ request: AIRequest) throws {
        ...
        guard hasContent else {
            ...
            throw ArbiterError.invalidRequest(reason: "Prompt cannot be empty or whitespace-only")
        }
    }
