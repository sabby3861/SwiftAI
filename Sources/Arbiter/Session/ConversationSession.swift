...
public final class ConversationSession: Identifiable {
    ...
    public func send(_ text: String, using ai: Arbiter, options: RequestOptions? = nil) async throws {
        guard !isGenerating else {
            throw ArbiterError.invalidRequest(reason: "A request is already in progress. Wait for it to complete or cancel it first.")
        }
    ...
    public func sendStreaming(
        ...
        guard !isGenerating else {
            return AsyncThrowingStream { continuation in
                continuation.finish(throwing: ArbiterError.invalidRequest(
