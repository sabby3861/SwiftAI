...
private let logger = Logger(subsystem: "com.arbiter", category: "RetryEngine")
...
struct RetryEngine: Sendable {
    ...
    func execute<T: Sendable>(
        ...
        throw lastError ?? ArbiterError.invalidRequest(reason: "Retry engine exhausted with no error")
    }
