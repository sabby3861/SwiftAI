...
/// Errors that can occur when using SwiftAI
public enum SwiftAIError: Error, Sendable {
...
extension SwiftAIError: LocalizedError {
    ...
    public var recoverySuggestion: String? {
        ...
        case .decodingFailed:
            "This may indicate an API change. Update SwiftAI to the latest version."
        case .httpError:
