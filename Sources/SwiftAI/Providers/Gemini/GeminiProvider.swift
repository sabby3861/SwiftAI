...
private let logger = Logger(subsystem: "com.swiftai", category: "GeminiProvider")
...
private extension GeminiProvider {
    ...
    func buildURLRequest(modelName: String, stream: Bool, body: Data) throws -> URLRequest {
        ...
        guard let requestURL = components.url else {
            throw SwiftAIError.invalidRequest(reason: "Failed to build Gemini URL for model: \(modelName)")
        }
